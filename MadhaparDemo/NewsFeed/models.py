...
class NewsFeed(models.Model):
	...
	news_image1 = models.ImageField(upload_to = upload_location, 
		null=True,
		blank=True, 
		width_field = "width_field", 
		height_field = "height_field", verbose_name = 'News Image 1')
	news_image2 = models.ImageField(upload_to = upload_location, 
		null=True,
		blank=True, 
		width_field = "width_field", 
		height_field = "height_field", verbose_name = 'News Image 2')
	news_image3 = models.ImageField(upload_to = upload_location, 
		null=True,
		blank=True, 
		width_field = "width_field", 
		height_field = "height_field", verbose_name = 'News Image 3')
	news_image4 = models.ImageField(upload_to = upload_location, 
		null=True,
		blank=True, 
		width_field = "width_field", 
		height_field = "height_field", verbose_name = 'News Image 4')
	news_image5 = models.ImageField(upload_to = upload_location, 
		null=True,
		blank=True, 
		width_field = "width_field", 
		height_field = "height_field", verbose_name = 'News Image 5')
